...
return array(
	...
	"FEEDBACK_PLAYER_CREATION_FAILED" => "Player creation failed.",
	"FEEDBACK_PLAYER_EDITING_FAILED" => "Player editing failed.",
	"FEEDBACK_PLAYER_DELETION_FAILED" => "player deletion failed.",
	...
	"NOUWEN_IS_EPIC" => "Meneer Nouwen is super super epic!",
);
